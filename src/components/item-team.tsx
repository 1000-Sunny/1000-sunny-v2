...
import { IndexPageQuery_team_edges_node } from "../pages/__generated__/IndexPageQuery"

type ItemTeamProps = { data: IndexPageQuery_team_edges_node, even: boolean };
export const ItemTeam: React.FC<ItemTeamProps> = ({ data, even }) => {
    ...
    return (
        <Parallax changePercentage={updateState}>
            <div className="large-container mx-auto">
                <div
                    className={`my-4 py-8 lg:py-24 team-item md:flex ${
