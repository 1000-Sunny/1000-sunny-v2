...
const ListItem = ({ data }) => {
    return (
        <li className="inline-block social-link mx-2">
            <a href={data.url} title={data.name} target="_blank" rel="noopener noreferrer" className="rounded-full inline-block transition-shadow duration-300 hover:shadow-2xl">
